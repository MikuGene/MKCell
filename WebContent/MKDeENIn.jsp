			...
			<ul class="nav-list nav-right">
				...
				<li class="active">
					...
					<div class="dropdown-menu">
						...
						<a href="MKalyScpNIn.html?Email=<%=Email%>">Cell recognition</a>
...
<div class="adapt card text-center"><br>
 <h3><strong>DE-Genes Test --- MKCell</strong></h3><br>
 <img class="img-sm" src="MKupload/<%=MKID%>/MKdeRe/MK_De.png" alt="Error, there is no result of this run." width = 500 height = auto><br><br>
 <a href="MKupload/<%=MKID%>/MKdeRe/MK_De.csv" class="btn btn-md btn-warn" role="button">DEG-result download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKdeRe/MK_De.tiff" class="btn btn-md btn-warn" role="button">DEG.tiff download</a><br><br>
 <a href="MKalyDeENIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">Go back</a><br><br>
</div>
</body>
