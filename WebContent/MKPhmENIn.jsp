...
<div class="adapt card text-center"><br>
 <h3><strong>HeatMap --- MKCell</strong></h3><br>
 <img class="img-sm" src="MKupload/<%=MKID%>/MKphmRe/MK_phm.png" alt="Error, there is no result of this run." width = 500 height = auto><br><br>
 <a href="MKupload/<%=MKID%>/MKphmRe/MK_phm.csv" class="btn btn-md btn-warn" role="button">HeatMap.csv download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKphmRe/MK_phm.tiff" class="btn btn-md btn-warn" role="button">HeatMap.tiff download</a><br><br>
 <a href="MKalyPhmENIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">Go back</a><br><br>
 </div>
</body>
