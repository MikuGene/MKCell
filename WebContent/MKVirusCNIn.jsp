...
<div class="adapt card text-center"><br>
 <h3><strong>病毒序列比对 --- MKCell</strong></h3><br>
 ...
 <a href="MKupload/<%=MKID%>/MKvirRe/MKvir_Genome.csv" class="btn btn-md btn-warn" role="button">Vir-Genome.csv 下载</a><br><br>
 <a href="MKupload/<%=MKID%>/MKvirRe/MKvir_Gene.csv" class="btn btn-md btn-warn" role="button">Vir-Gene.csv 下载</a><br><br>
 <a href="MKupload/<%=MKID%>/MKvirRe/MKvirus.BAM" class="btn btn-md btn-warn" role="button">Vir.bam 下载</a><br><br>
 <a href="MKalyVirCNIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">回退</a><br><br>
 </div>
</body>
