...
<div class="adapt card text-center"><br>
 <h3><strong>组织状态估算 --- MKCell</strong></h3><br>
 ...
 <a href="MKupload/<%=MKID%>/MKstateRe/MK_State.csv" class="btn btn-md btn-warn" role="button">MKstate.csv 下载</a><br><br>
 <a href="MKupload/<%=MKID%>/MKstateRe/MK_State.tiff" class="btn btn-md btn-warn" role="button">MKstate.tiff 下载</a><br><br>
 <a href="MKalyStaCNIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">回退</a><br><br>
 </div>
</body>
