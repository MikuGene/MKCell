...
<div class="adapt card text-center"><br>
 <h3><strong>ScRNA Cluster --- MKCell</strong></h3><br>
 <img class="img-sm" src="MKupload/<%=MKID%>/MKscRNARe/MK_scRNA.png" alt="Error, there is no result of this run." width = 500 height = auto><br><br>
 <a href="MKupload/<%=MKID%>/MKscRNARe/MK_scRNA.rds" class="btn btn-md btn-warn" role="button">ScRNA.rds download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKscRNARe/MK_scRNA.tiff" class="btn btn-md btn-warn" role="button">ScRNA.tiff download</a><br><br>
 <a href="MKalyScpENIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">Go back</a><br><br>
 </div>
</body>
