...
<div class="adapt card text-center"><br>
 <h3><strong>Unsupervised clustering --- MKCell</strong></h3><br>
 <img class="img-sm" src="MKupload/<%=MKID%>/MKclustRe/MK_Clt.png" alt="Error, there is no result of this run." width = 500 height = auto><br><br>
 <a href="MKupload/<%=MKID%>/MKclustRe/MK_cluster.csv" class="btn btn-md btn-warn" role="button">Cluster-result.csv download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKclustRe/MK_Clt.tiff" class="btn btn-md btn-warn" role="button">Cluster-plot.tiff download</a><br><br>
 <a href="MKalyCltENIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">Go back</a><br><br>
</div>
</body>
