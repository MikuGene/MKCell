...
<div class="adapt card text-center"><br>
 <h3><strong>细胞组分估算 --- MKCell</strong></h3><br>
 ...
 <a href="MKupload/<%=MKID%>/MKcellRe/MK_Cell.csv" class="btn btn-md btn-warn" role="button">MKcell.csv 下载</a><br><br>
 <a href="MKupload/<%=MKID%>/MKcellRe/MK_Cell.tiff" class="btn btn-md btn-warn" role="button">MKcell.tiff 下载</a><br><br>
 <a href="MKalyDCoCNIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">回退</a><br><br>
 </div>
</body>
