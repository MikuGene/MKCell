...
<div class="adapt card text-center"><br>
 <h3><strong>Deconvolution --- MKCell</strong></h3><br>
 <img class="img-sm" src="MKupload/<%=MKID%>/MKcellRe/MK_cell.png" alt="Error, there is no result of this run." width = 500 height = auto><br><br>
 <a href="MKupload/<%=MKID%>/MKcellRe/MK_Cell.csv" class="btn btn-md btn-warn" role="button">MKcell.csv download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKcellRe/MK_Cell.tiff" class="btn btn-md btn-warn" role="button">MKcell.tiff download</a><br><br>
 <a href="MKalyDCoENIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">Go back</a><br><br>
 </div>
</body>
