...
<div class="adapt card text-center"><br>
 <h3><strong>无监督聚类 --- MKCell</strong></h3><br>
 ...
 <a href="MKupload/<%=MKID%>/MKclustRe/MK_cluster.csv" class="btn btn-md btn-warn" role="button">Cluster.csv 下载</a><br><br>
 <a href="MKupload/<%=MKID%>/MKclustRe/MK_Clt.tiff" class="btn btn-md btn-warn" role="button">Cluster-plot.tiff 下载</a><br><br>
 <a href="MKalyCltCNIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">回退</a><br><br>
</div>
</body>
