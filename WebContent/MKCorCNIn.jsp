...
<div class="adapt card text-center"><br>
 <h3><strong>基因表达相关性分析 --- MKCell</strong></h3><br>
 ...
 <a href="MKupload/<%=MKID%>/MKcorRe/MK_Cor.csv" class="btn btn-md btn-warn" role="button">Correlation.csv 下载</a><br><br>
 <a href="MKupload/<%=MKID%>/MKcorRe/MK_Cor1.tiff" class="btn btn-md btn-warn" role="button">Pearson.tiff 下载</a><br><br>
 <a href="MKupload/<%=MKID%>/MKcorRe/MK_Cor2.tiff" class="btn btn-md btn-warn" role="button">Spearman.tiff 下载</a><br><br>
