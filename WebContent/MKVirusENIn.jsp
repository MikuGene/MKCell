...
<div class="adapt card text-center"><br>
 <h3><strong>Vrius Mapping --- MKCell</strong></h3><br>
 <img class="img-sm" src="MKupload/<%=MKID%>/MKvirRe/MK_Virus1.png" alt="Error, there is no result of this run." width = 450 height = auto>
 <img class="img-sm" src="MKupload/<%=MKID%>/MKvirRe/MK_Virus2.png" alt="Error, there is no result of this run." width = 450 height = auto><br><br>
 <a href="MKupload/<%=MKID%>/MKvirRe/MKvir_Genome.csv" class="btn btn-md btn-warn" role="button">Vir-Genome.csv download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKvirRe/MKvir_Gene.csv" class="btn btn-md btn-warn" role="button">Vir-Gene.csv download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKvirRe/MKvirus.BAM" class="btn btn-md btn-warn" role="button">Vir.bam download</a><br><br>
 <a href="MKalyVirENIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">Go back</a><br><br>
 </div>
</body>
