...
<div class="adapt card text-center"><br>
 <h3><strong>Tissue state --- MKCell</strong></h3><br>
 <img class="img-sm" src="MKupload/<%=MKID%>/MKstateRe/MK_state.png" alt="Error, there is no result of this run." width = 500 height = auto><br><br>
 <a href="MKupload/<%=MKID%>/MKstateRe/MK_State.csv" class="btn btn-md btn-warn" role="button">MKstate.csv download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKstateRe/MK_State.tiff" class="btn btn-md btn-warn" role="button">MKstate.tiff download</a><br><br>
 <a href="MKalyStaENIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">Go back</a><br><br>
 </div>
</body>
