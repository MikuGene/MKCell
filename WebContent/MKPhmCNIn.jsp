...
<div class="adapt card text-center"><br>
 <h3><strong>热图绘制 --- MKCell</strong></h3><br>
 ...
 <a href="MKupload/<%=MKID%>/MKphmRe/MK_phm.csv" class="btn btn-md btn-warn" role="button">HeatMap.csv 下载</a><br><br>
 <a href="MKupload/<%=MKID%>/MKphmRe/MK_phm.tiff" class="btn btn-md btn-warn" role="button">HeatMap.tiff 下载</a><br><br>
 <a href="MKalyPhmCNIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">回退</a><br><br>
 </div>
</body>
