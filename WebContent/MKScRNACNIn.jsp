...
<div class="adapt card text-center"><br>
 <h3><strong>单细胞分群识别 --- MKCell</strong></h3><br>
 ...
 <a href="MKupload/<%=MKID%>/MKscRNARe/MK_scRNA.rds" class="btn btn-md btn-warn" role="button">ScRNA.rds 下载</a><br><br>
 <a href="MKupload/<%=MKID%>/MKscRNARe/MK_scRNA.tiff" class="btn btn-md btn-warn" role="button">ScRNA.tiff 下载</a><br><br>
 <a href="MKalyScpCNIn.html?Email=<%=Email%>" class="btn btn-md btn-inf" role="button">回退</a><br><br>
 </div>
</body>
