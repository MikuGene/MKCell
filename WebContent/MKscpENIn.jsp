	...
	<nav class="nav-main">
		...
		<div class="collapse nav-cont" id="MKnav">
			<ul class="nav-list nav-right">
				...
				<li class="active">
					<a href='MKPancENIn.html?Email=<%=Email%>'>Pan-cancer View<span class='hiden'>(current)</span></a>
				</li>
				<li>
				    <a class="triang" href="MKalyENIn.html?Email=<%=Email%>">Analysis</a>
...
<div class="adapt card text-center"><br>
 <h3><strong>ScRNA Gene Plot --- MKCell</strong></h3><br>
 ...
 <a href="MKupload/<%=MKID%>/MKscpRe/MK_global.tiff" class="btn btn-md btn-warn" role="button">Global-tSNE Tiff Download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKscpRe/MK_scg_tSNE.tiff" class="btn btn-md btn-warn" role="button">Gene-tSNE Tiff Download</a><br><br>
 <a href="MKupload/<%=MKID%>/MKscpRe/MK_scg_vln.tiff" class="btn btn-md btn-warn" role="button">Gene-vln Tiff Download</a><br><br>
 <a class='btn btn-md btn-inf' role='button' href='MKPancENIn.html?Email=<%=Email%>'>Go back</a><br><br>
</div>
</body>
