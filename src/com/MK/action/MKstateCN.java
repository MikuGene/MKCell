...
public class MKstateCN {
    ...
    public String MKupstateCN() throws RserveException, InterruptedException{
    	try {
    		...
    		File MKdest = new File(MKpath,"MKstate");
    		...
    		try{
    			...
    			rc.eval("source(\"D:/MKr/MK_state.r\")");
    			rc.shutdown();}
    		catch(Exception e){
    			rc.shutdown();}
    		}
